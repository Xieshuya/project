...
<title>信息运维人员专业技能培训平台 - 知识库储备库 - 知识库</title>
<link href="${pageContext.request.contextPath}/resource/css/common/common.css" rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/resource/css/knowledgeRepository/knowledgeBase/knowledgeBase.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/script/jquery/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/knowledgeRepository/knowledgeBase/knowledgeBase.js"></script>
</head>
...
<div id="mainDiv">
	<div class="rightPage_topBar_bg">
        ...
        <div class="rightPage_topBar_rightBar">知识库储备库&nbsp;<img src="${pageContext.request.contextPath}/resource/image/system/rightPage_topBar_rightBar_doublegt.gif" />&nbsp;知识库</div>
    </div>
