...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td id="index_banner" height="200" valign="bottom" class="index_banner"><table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" class="index_banner_navigation_bg">
      <tr>
        ...
        <td width="1" height="40" style="background-color:#FFF;"></td>
        <td id="navigationItem3" width="137" height="40" align="center" onmouseover="mouseInNavigationItem(3)" onmouseout="mouseOutNavigationItem(3)" onmousedown="mouseDownNavigationItem(3)" style="cursor: pointer;">培训方案</td>
        <td width="1" height="40" style="background-color:#FFF;"></td>
        <td id="navigationItem4" width="137" height="40" align="center" onmouseover="mouseInNavigationItem(4)" onmouseout="mouseOutNavigationItem(4)" onmousedown="mouseDownNavigationItem(4)" style="cursor: pointer;">知识储备库</td>
        <td width="1" height="40" style="background-color:#FFF;"></td>
        <td id="navigationItem5" width="137" height="40" align="center" onmouseover="mouseInNavigationItem(5)" onmouseout="mouseOutNavigationItem(5)" onmousedown="mouseDownNavigationItem(5)" style="cursor: pointer;">技能培训</td>
        <td width="1" height="40" style="background-color:#FFF;"></td>
        <td id="navigationItem6" width="137" height="40" align="center" onmouseover="mouseInNavigationItem(6)" onmouseout="mouseOutNavigationItem(6)" onmousedown="mouseDownNavigationItem(6)" style="cursor: pointer;">技能演练</td>
        <td width="1" height="40" style="background-color:#FFF;"></td>
        <td id="navigationItem7" width="137" height="40" align="center" onmouseover="mouseInNavigationItem(7)" onmouseout="mouseOutNavigationItem(7)" onmousedown="mouseDownNavigationItem(7)" style="cursor: pointer;">技能考核</td>
        <td width="1" height="40" style="background-color:#FFF;"></td>
        <td id="navigationItem8" width="137" height="40" align="center" onmouseover="mouseInNavigationItem(8)" onmouseout="mouseOutNavigationItem(8)" onmousedown="mouseDownNavigationItem(8)" style="cursor: pointer;">技能评价</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td valign="top"><table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
              ...
              <tr>
                <td height="35"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="76%" height="30" class="index_information_content"><a href="#">吉林省电力有限公司吉林省电力...</a></td>
                    <td width="16%" height="30" class="index_information_content">04/20</td>
                  </tr>
                </table></td>
              </tr>
              <tr>
        ...
        <td width="550" align="right" valign="top"><table width="545" border="0" cellpadding="0" cellspacing="0" class="index_information_bg">
          <tr>
            <td width="186" height="50" align="left" class="index_information_title">新闻中心</td>
            <td width="357" height="50" align="right" class="index_information_more"><a href="#">更多...</a></td>
          </tr>
          <tr>
            ...
            <td height="200"><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td height="35"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="8%" height="30" align="center" class="index_information_number1">1</td>
                    <td width="76%" height="30" class="index_information_content"><a href="#">吉林省电力有限公司吉林省电力有...</a></td>
                    <td width="16%" height="30" class="index_information_content">04/20</td>
                  </tr>
                </table></td>
              </tr>
      ...
      <tr>
        <td width="550" align="left" valign="top"><table width="545" border="0" cellpadding="0" cellspacing="0" class="index_information_bg">
          <tr>
            <td width="186" height="50" align="left" class="index_information_title">下载专区</td>
            <td width="357" height="50" align="right" class="index_information_more"><a href="#">更多...</a></td>
          </tr>
          <tr>
        ...
        <td width="550" align="right" valign="top"><table width="545" border="0" cellpadding="0" cellspacing="0" class="index_information_bg">
          <tr>
            <td width="186" height="50" align="left" class="index_information_title">动态信息</td>
            <td width="357" height="50" align="right" class="index_information_more"><a href="#">更多...</a></td>
          </tr>
          <tr>
  ...
  <tr>
    <td height="30" align="center" class="index_bottom index_bottom_bg">Copyright &copy;  信息运维人员专业技能培训平台 Beta 1.0</td>
  </tr>
  <tr>
